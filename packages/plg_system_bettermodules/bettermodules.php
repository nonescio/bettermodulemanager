 ...
 */
class PlgSystemBetterModules extends JPlugin
{
	private $_alias       = 'bettermodules';
	private $_title       = 'BETTER_MODULE_MANAGER';
	private $_lang_prefix = 'VMM';
	...
	/*
	 * Replace links to com_modules with com_bettermodules
	 */
	...
	private function getHelper()
	{
		...
		if (!JFile::exists(JPATH_ADMINISTRATOR . '/components/com_bettermodules/bettermodules.php'))
		{
			return false;
		}
		...
		$params = RLParameters::getInstance()->getComponentParams('bettermodules');
