 ...
 */
class BetterModulesControllerModule extends JControllerForm
{
	/**
	...
	public function add()
	{
		...
		$app->setUserState('com_bettermodules.add.module.extension_id', $extensionId);
		$app->setUserState('com_bettermodules.add.module.params', null);

		// Parameters could be coming in for a new item, so let's set them.
		$params = $app->input->get('params', array(), 'array');
		$app->setUserState('com_bettermodules.add.module.params', $params);
	}
	...
	public function cancel($key = null)
	{
		...
		$app->setUserState('com_bettermodules.add.module.extension_id', null);
		$app->setUserState('com_bettermodules.add.module.params', null);
	...
	public function batch($model = null)
	{
		...
		// Preset the redirect
		$redirectUrl = 'index.php?option=com_bettermodules&view=modules' . $this->getRedirectToListAppend();
	...
	protected function postSaveHook(JModelLegacy $model, $validData = array())
	{
		...
		{
			case 'save2new':
				$app->setUserState('com_bettermodules.add.module.extension_id', $model->getState('module.extension_id'));
				break;
