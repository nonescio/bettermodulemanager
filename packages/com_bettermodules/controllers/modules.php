 ...
 */
class BetterModulesControllerModules extends JControllerAdmin
{
	/**
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_bettermodules&view=modules');
	}
	 ...
	 */
	public function getModel($name = 'Module', $prefix = 'BetterModulesModel', $config = array('ignore_request' => true))
	{
