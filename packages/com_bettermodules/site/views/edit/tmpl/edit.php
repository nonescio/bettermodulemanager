...
<form action="<?php echo JRoute::_('index.php?option=com_bettermodules&view=edit&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm"
	...
	<div class="row-fluid">
		...
		<div class="span12">
			...
			<h1 class="page_title">
				<?php echo JText::sprintf('BMM_MODULE_EDIT', $this->item->title . ' <span class="label label-default">' . $this->item->module . '</span>'); ?>
			</h1>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<?php if ($this->item->client_id == 0) : ?>
						<?php echo JHtml::_('bootstrap.addSlide', 'moduleSlide', JText::_('BMM_ASSIGNMENTS'), 'assignment'); ?>
