...
{
	$msg = JText::_('BMM_REGULAR_LABS_LIBRARY_NOT_INSTALLED')
		. ' ' . JText::sprintf('BMM_EXTENSION_CAN_NOT_FUNCTION', JText::_('COM_BETTERMODULES'));
...
{
	$msg = JText::_('BMM_REGULAR_LABS_LIBRARY_NOT_ENABLED')
		. ' ' . JText::sprintf('BMM_EXTENSION_CAN_NOT_FUNCTION', JText::_('COM_BETTERMODULES'));
...
$controller = JControllerLegacy::getInstance('BetterModules');
