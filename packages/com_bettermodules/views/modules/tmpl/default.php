...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_bettermodules&task=modules.saveOrderAjax&tmpl=component';
...
?>
<form action="<?php echo JRoute::_('index.php?option=com_bettermodules'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<div id="j-main-container"<?php echo (!empty($this->sidebar)) ? ' class="span10"' : ''; ?>>
				...
				<thead>
					<tr>
						...
						<?php if ($showcolors) : ?>
							<?php $cols++; ?>
							<th width="1%" class="nowrap center hidden-phone">
								<?php echo JHtml::_('searchtools.sort', '', 'color', $listDirn, $listOrder, null, 'asc', 'BMM_COLOR', 'icon-color'); ?>
							</th>
						<?php endif; ?>
						<th class="title">
						...
						<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->position ? $item->position : 'none'; ?>">
							...
							<td class="has-context">
								<div class="pull-left">
									...
									$tooltip = '<strong>' . JText::_('BMM_EDIT_MODULE') . '</strong><br>' . htmlspecialchars($title);
									...
									?>
									<?php if ($canEdit) : ?>
										<a href="<?php echo JRoute::_('index.php?option=com_bettermodules&task=module.edit&id=' . (int) $item->id); ?>">
											<?php echo $title; ?></a>
									<?php else : ?>
										<?php echo $title; ?>
									<?php endif; ?>
		...
		<?php if ($this->config->show_switch) : ?>
			<div style="text-align:right">
				<a href="<?php echo JRoute::_('index.php?option=com_modules&force=1'); ?>"><?php echo JText::_('BMM_SWITCH_TO_CORE'); ?></a>
			</div>
		<?php endif; ?>
	</div>
</form>
