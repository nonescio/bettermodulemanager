...
class BetterModulesViewModule extends JViewLegacy
{
	...
	public function display($tpl = null)
	{
		...
		if (preg_match('#_gk[1-9]#', $this->item->module))
		{
			...
			JFactory::getApplication()->enqueueMessage(JText::sprintf(html_entity_decode(JText::_('BMM_MODULE_INCOMPATIBLE')), '<a href="index.php?option=com_modules&force=1&task=module.edit&id=' . (int) $this->item->id . '">', '</a>'), 'warning');
		}
	...
	protected function getAssignments()
	{
		...
		{
			$xmlfile     = JPATH_ADMINISTRATOR . '/components/com_bettermodules/assignments.xml';
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(JText::sprintf('BMM_MODULE_EDIT', $title), 'bettermodulemanager icon-reglab');
		...
		if ($tmpl != 'component')
		{
			...
			{
				JToolbarHelper::preferences('com_bettermodules', 600, 900);
			}
