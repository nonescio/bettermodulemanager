...
if (JFactory::getUser()->authorise('core.admin'))
{
	...
	jQuery(document).ready(function()
	{
		...
		{
			if(confirm('" . str_replace('<br>', '\n', JText::_('BMM_DISABLE_ASSIGNMENT', true)) . "')) {
...
<form action="<?php echo JRoute::_('index.php?option=com_bettermodules&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm"
	...
	<div class="form-horizontal">
						...
						<div class="control-group">
							<div class="control-label">
								<label id="advancedparams_color-lbl" for="advancedparams_color" class="hasTooltip" title=""
								       data-original-title="<strong><?php echo JText::_('BMM_COLOR', true); ?></strong><br><?php echo JText::_('BMM_COLOR_DESC', true); ?>">
									<?php echo JText::_('BMM_COLOR'); ?>
								</label>
							</div>
							<div class="controls">
								<?php
		...
		<?php if ($this->item->client_id == 0) : ?>
			<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'assignment', JText::_('BMM_ASSIGNMENTS', true)); ?>
		...
		<?php if ($this->config->show_switch) : ?>
			<div style="text-align:right">
				<a href="<?php echo JRoute::_('index.php?option=com_modules&force=1&task=module.edit&id=' . (int) $this->item->id); ?>"><?php echo JText::_('BMM_SWITCH_TO_CORE'); ?></a>
			</div>
		<?php endif; ?>
	</div>
</form>
